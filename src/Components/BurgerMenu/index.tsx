...
export default function BurgerMenu({setOpenBurger}: NavBarProps) {
    ...
    return (
        <>
            <Flex pos={"absolute"} w="100%" h="100vh" overflow={"none"} justifyContent={"center"} alignItems={"center"} zIndex={3000}>
                <motion.div  style={{ width: "100%", height: "100%", background: "rgb(0, 0, 0, 0.8)", position: "absolute", zIndex: 3002, overflow: "none" }} onClick={() => setOpenBurger(false) }>
                </motion.div>
