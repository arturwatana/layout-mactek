    ...
    return (
        ...
        <Flex w="100vw" h="100%" position={"relative"} alignItems={"center"} justifyContent={"center"} flexDir={"column"}>
            ...
            <Flex zIndex={400} w="100%" maxW="1280px" pb="50px " h="100%" minH="70vh" alignItems={"center"} flexDirection={"column"} >
                ...
                {module ? <>
                    <Flex textAlign={"left"} w={{sm: "90%", lg:"80%"}}   zIndex={900} p={{sm: "60px 0 0 0", lg:"120px 0 0 0"}} >
                    <Flex flexDir={"column"} gap="40px">
                        <Heading color={"#fbc431"} w="100%" textAlign={{sm: "center", lg: "start"}}  fontWeight={400} fontSize={"46px"} >{module.name}</Heading>
            ...
            <Flex zIndex={300} w="100%" maxW="1280px" pb="50px " h="100%" minH="70vh" alignItems={"center"} flexDirection={"column"} >
                  <Flex p="64px 0 0 0 " w="100%"  flexDir={"column"}>
                      ...
                      <Flex w="100%" mt="64px"  alignItems={{sm:"center", lg:"start"}} gap={{sm:"15px", lg: "0px"}} justifyContent={"space-around"} flexDir={{sm:"column", lg:"row"}}>
                        <Flex w={{sm: "90%", lg:"290px"}} background="rgb(255, 255, 255, 0.9)" h={{sm:"100%", lg:"390px"}}  gap="20px" flexDir={"column"} alignItems={"center"} p="25px 20px 10px 20px" borderRadius={"5px"} boxShadow={"1px 1px 3px #222"}>
                        ...
                        <Flex w={{sm: "90%", lg:"290px"}} h={{sm:"100%", lg:"390px"}} background="rgb(255, 255, 255, 0.9)" gap="20px" flexDir={"column"} alignItems={"center"} p="25px 20px 10px 20px" borderRadius={"5px"} boxShadow={"1px 1px 3px #222"}>
                            <Image src={FolderFiles} w={{sm: "30%", lg:"60%"}}/>
                            <Text fontSize={"26px"} fontWeight={300}>Sub-Title</Text>
                            <Text fontSize={"16px"} fontWeight={200} textAlign={"center"}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's stan</Text>
                        </Flex>
